        ...
        body.onscroll = function () {
            ...
            try {
                for (var _iterator = document.getElementsByTagName("iframe")[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    try {
                        for (var _iterator4 = iframe.querySelectorAll("[" + trigger + "]" + "[class~=" + trigger + "]")[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                    ...
                    try {
                        for (var _iterator5 = iframe.querySelectorAll("[" + trigger + "=" + sectionID + "]")[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
            ...
            try {
                for (var _iterator2 = document.querySelectorAll("[" + trigger + "]" + "[class~=" + active + "]")[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    ...
                    if (typeof remove === "function") {
                        ...
                        _$activedEl.classList.remove(active);
                    }
                }
            } catch (err) {
            ...
            try {
                for (var _iterator3 = document.querySelectorAll("[" + trigger + "=" + sectionID + "]")[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                    ...
                    if (typeof add === "function") {
                        ...
                        _$triggerEl.classList.add(active);
                    }
                }
            } catch (err) {
